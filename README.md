...
nutshell, SpaCET first infers <b>cancer cell abundance</b> by
...
calibrate local tissue densities and determine <b>stromal and immune
cell lineage fractions</b> based on a comprehensive non-malignant cell
atlas. Furthermore, SpaCET has the capability to unveil putative
<b>cell-cell interactions within the tumor microenvironment</b>,
...
dataset. These functionalities are explained more formally in the
following tutorials.
