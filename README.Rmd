...
in cancer progression. SpaCE first estimates cancer cell abundance through 
modeling the segmental copy number
variations. SpaCE then uses a constrained regression model to calibrate
local tissue densities and determine stromal and immune cell lineage
hierarchies. Further, SpaCE can reveal how intercellular signaling
