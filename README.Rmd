...
* R version >= 4.2.0. 
* R packages: Matrix, jsonlite, ggplot2, reshape2, patchwork, png, shiny, plotly, DT, MUDAN, factoextra, NbClust, cluster, parallel, pbmcapply, psych, BiRewire, limma, arrow, UCell.
