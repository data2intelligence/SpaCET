...
Or user can install `SpaCET` from the local source code. Click [<a href="https://api.github.com/repos/data2intelligence/SpaCET/tarball/HEAD" target="_blank">here</a>] to download it.
