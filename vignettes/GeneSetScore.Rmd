---
title: "Gene set score calculation for spatial spots"
output: rmarkdown::html_vignette
description: >
  Gene set score calculation for spatial spots.
vignette: >
  %\VignetteIndexEntry{Gene set score calculation for spatial spots}
...
A recent [study](https://www.nature.com/articles/s41588-022-01141-9){target="_blank"} identifies a catalog of gene modules whose expression defines 16 recurrent cancer cell states through a pan-cancer single-cell RNA-sequencing analysis. In order to use them, user just need to set `GeneSets` as "CancerCellState".
