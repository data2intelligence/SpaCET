...
To create an SpaCET object, user need to prepare four types of input data referring to a tumor ST dataset. 
...
SpaCET.visualize.deconvolution(
  SpaCET_obj, 
