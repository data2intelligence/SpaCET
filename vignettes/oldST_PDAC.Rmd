...
Here, since the PDAC ST data set was generated from the original ST technology, user need `create.SpaCET.object` to create an SpaCET object by preparing four types of input data referring to a tumor ST sample. 
