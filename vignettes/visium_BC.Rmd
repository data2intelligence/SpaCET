...
Here, we create an SpaCE object for this breast cancer visium dataset. In this step, the genes exhibiting zero UMI counts across spots will be removed. Also, if there are duplicated gene symbols, the gene with the highest total counts remains and all other duplicated genes are removed.
...
The UMI count matrix is stored in `SpaCE_obj@input$counts` as a sparse matrix. Each row represents a gene whereas each column is a spot. Of note, the column name is the ID of spots with a format "AxB", which means the horizontal (A) and vertical (B) order of each spot, respectively.

``` r
# show this object.
SpaCE_obj@input$counts[1:8,1:8]
## 8 x 8 sparse Matrix of class "dgCMatrix"
##            50x102 59x19 14x94 47x13 73x43 61x97 45x115 42x28
## AL627309.1      .     .     .     .     .     1      .     .
## AL669831.2      .     .     .     .     .     .      .     .
## AL669831.5      .     2     .     .     .     .      .     .
## FAM87B          .     .     .     .     .     .      .     .
