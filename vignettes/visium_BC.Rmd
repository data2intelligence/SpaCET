...
Here, we create an SpaCET object for the current breast cancer visium sample. In this step, if there are duplicated gene symbols, the gene with the highest total counts remains and all other duplicated genes are removed.
