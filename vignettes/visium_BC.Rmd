...
Since some cell types have relatively low abundance, user can get a better vision by setting `sameScaleForFraction = FALSE`.
...
``` 
<img src="img/cancerInterface2.png" width="60%" style="border:none" />
